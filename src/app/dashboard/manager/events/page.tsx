...
import { listManagerEvents } from '@/app/dashboard/events/actions'
...
export default async function ManagerEventsPage() {
  const allEvents = await listManagerEvents()
        ...
        {allEvents.length === 0 && (
          ...
          >
            ...
            <p className="text-sm font-medium" style={{ color: '#353148' }}>
              Aucun événement pour vos équipes
            </p>
...
type Event = Awaited<ReturnType<typeof listManagerEvents>>[number]
